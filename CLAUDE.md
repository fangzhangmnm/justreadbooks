...
- **书架 = `@internal/gallery`**（`src/gallery-host.ts`；云图标在书架顶栏，设置里没有登录）。缺口不手搓：列表视图 / 全屏 / 副标题·未读 hook / 留离线动词 → 包提案 `../20260909 internal-gallery/ai-docs/20260919-proposal-list-view.md`（待 user 过目 → 0.3.0）。
