// settle-hold —— （2026-09-09 从 WeebPaint src/common/settle-hold.ts 原样搬入 WXHW，对账审计 #5）「等某个 promise 落地（成功或失败都算），但最多等 maxMs」的纯函数。
// created 2026-09-05 by Claude Fable 5.1（WXHW）· 2026-09-19 拷入 JRB by Claude Fable 5.1。
//
